...
/*
fb:     front buffer base address, such as 0xa0-0000
Xsize:  the XResolution. the number of pixels per row
x, y:   the left top pixel postion at which will show a character
FRcolor:front color
BKcolor:background color
font:   the character wanted to be showed on the screen
*/
...
/*
根据可变参数args格式化fmt，结果放入buf中，返回字符串的长度
fmt:    以0x00结尾的格式化字符串
*/
int vsprintf(char *buf, const char *fmt, va_list args)
{
        ...
        repeat:
                ...
                {
                case '-':
                        flags |= LEFT;          /*0001 0000*/
                        goto repeat;
                case '+':
                        flags |= PLUS;          /*0000 0100*/
                        goto repeat;
                case ' ':
                        flags |= SPACE;         /*0000 1000*/
                        goto repeat;
                case '#':
                        flags |= SPECIAL;       /*0010 0000*/
                        goto repeat;
                case '0':
                        flags |= ZEROPAD;       /*0000 0001*/
                        goto repeat;
                }
